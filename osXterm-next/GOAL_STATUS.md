...
- All 48 Swift Testing core tests passed macro expansion and type checking with the Xcode Testing plugin, including broadcast source and recipient routing rules.
