...
- All 52 Swift Testing core tests passed macro expansion and type checking with the Xcode Testing plugin, including broadcast source and recipient routing rules, OpenSSH feature-baseline checks, and workspace persistence plus version rejection.
